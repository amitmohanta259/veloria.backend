...
public interface ClientBagService {
    ...
    void updateQuantity(String token, UUID productUuid, int quantity, String size) throws VeloriaException;
    void removeFromBag(String token, UUID productUuid, String size) throws VeloriaException;
    void clearBag(String token) throws VeloriaException;
    CartGstPreviewResponse getGstPreview(String token) throws VeloriaException;
}
